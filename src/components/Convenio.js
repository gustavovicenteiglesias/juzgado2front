...
const Convenio=(props)=>{
  ...
  const cuotasNuevas=()=>{
     ...
     let valorCuota=0
      ...
      valorCuota=((parseInt(currentTutorial.valor) - currentConvenio.anticipo)*(1+(interes/100)))/currentConvenio.cant_cuotas;
      setCurrentConvenio({...currentConvenio,valor_cuota:valorCuota})
